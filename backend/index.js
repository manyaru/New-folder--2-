...
const password = encodeURIComponent("hN80ROQ7V9zXfg51"); // i am encoding mogodb atlas password because my password has special charcters like "@"
const jwt=require('jsonwebtoken');

mongoose.connect(`mongodb+srv://alvinmureithi1:hN80ROQ7V9zXfg51@cluster0.hmayedv.mongodb.net/lenny?retryWrites=true&w=majority&appName=Cluster0`)
